...
<title>Shoes Store - Shopping Cart ahhah</title>
	...
	<div id="templatemo_header">
        ...
        <div id="header_right">
	        ...
	        <c:if test="${!empty sessionScope.user }">
	        	${user.nickname }
	        	<a href="${pageContext.request.contextPath }/user/UserServlet?op=lgout">退出</a> 
	        </c:if>
	        </p>
	        <p>
		        <c:if test="${!empty user }">
        ...
        <div id="content" class="float_r">
        	...
        	<form action="">
        	  <c:if test="${!empty user }">
        		...
        		<div>
			<table style="width: 680px;border-style:0px solid "  >
				<tr bgcolor="#ddd">
					<td width="20%">收件人姓名:</td>
	        	...
	        	<table width="680px" cellspacing="0" cellpadding="5">
	                   	  <tr bgcolor="#ddd">
		                      ...
		                      <c:forEach items="${order.orderitems}" var="item">
									<tr>
			                        	<td><img src="${pageContext.request.contextPath}/productimg/${item.product.imgurl }" style="width: 200px;height: 180px" alt="" /></td> 
			                        	<td>${item.product.pname }</td> 
			                            <td align="center"><font style="width: 20px; text-align: right" />${item.buynum }</font> </td>
			                            <td align="right">${item.product.estoreprice } </td> 
			                            <td align="right">${item.product.estoreprice*item.buynum } </td>
			                            <td align="center"> 
			                            	 hahaha
			                            </td>
									</tr>                      
