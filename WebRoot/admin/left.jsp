...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">商品管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath}/admin/CategoryServlet?op=findCategoryToAddProduct" target="rightFrame">添加商品</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/ProductServlet?op=findAllProduct&pageNum=1" target="rightFrame">查看/修改商品</a></li>
    ...
    <li> <a class="head">分类管理</a>
      <ul>
        ...
        <li><a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&pageNum=1" target="rightFrame">查看/删除分类</a></li>
      </ul>
    </li>
    ...
    <li> <a class="head">系统用户管理</a>
      <ul>
        ...
        <li><a href="${pageContext.request.contextPath }/admin/AdminServlet?op=findAllAdmin&pageNum=1" target="rightFrame">查看/修改系统用户</a></li>
      </ul>
    </li>
    ...
    <!--  <li> <a class="head">关于王道</a>
      <ul>
        <li><a href="01.jsp"  target="rightFrame">王道考研</a></li>
        <li><a href="#"  target="rightFrame">王道培训</a></li> 
      </ul>
    </li> -->
  </ul>
</div>
