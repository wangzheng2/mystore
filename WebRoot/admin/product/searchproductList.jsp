...
<script type="text/javascript">
	...
	function searchPage(num){
			 ...
			 var cid="${cid}";
 	         ...
 	         location.href="${pageContext.request.contextPath }/admin/ProductServlet?op=multiConditionSearch&pageNum="
					+ num
					+"&pid="+pid
					+"&cid="+cid 
					+"&pname="+pname 
...
<body>
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="javascript:searchPage(1)">首页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="javascript:searchPage('${page.previewPageNum}')">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="javascript:searchPage('${page.nextPageNum}')">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="javascript:searchPage('${page.totolPageNumber}')">尾页</a></span>
										</div>
									</td>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			window.location.href = "${pageContext.request.contextPath }/admin/ProductServlet?op=multiConditionSearch&pageNum="
					+ num
					+"&pid="+pid
					+"&cid="+cid 
					+"&pname="+pname 
