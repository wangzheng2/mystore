	...
	<head>
		...
		<script type="text/javascript">
		    ...
		    function setCategory(){
		    	...
		    	var selectInput = document.getElementById("st");
					 ...
					 <tr>
						...
						<td width="80%" height="20" bgcolor="d3eaef" class="STYLE6"><div
							...
							<img width="200px" height="180px"
							 src="${pageContext.request.contextPath}/productimg/${product.imgurl}"/>
