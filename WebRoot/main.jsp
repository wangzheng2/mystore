...
<title> 大工考研资料网</title>
<meta name="keywords" content=" store, free template, ecommerce, online shop, website templates, CSS, HTML" />
<meta name="description" content="s Store is a free ecommerce template provided " />
...
<body>
<c:if test="${empty productTop || empty  hotProducts}">
		<jsp:forward page="/MainPageServlet"></jsp:forward>
</c:if>
<div id="templatemo_body_wrapper">
<div id="templatemo_wrapper">
	
	<div id="templatemo_header"><div id="site_title"><h1><a href="http://localhost/${pageContext.request.contextPath }">Online  Store</a></h1></div>
        <div id="header_right">
        	<p>
        	...
        	<div id="slider-wrapper">
                <div id="slider" class="nivoSlider">
                	<c:forEach items="${productTop }" var="product">
                		<a href="${pageContext.request.contextPath }/ProductServlet?op=findProductByPid&pid=${product.pid}"><img src="productimg/${product.imgurl }" style="width: 680px;height: 300px" alt="" title="${product.pname }"/></a>
                	</c:forEach>
                </div>
